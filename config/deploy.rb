...
role :web, "damedia.com"                          # Your HTTP server, Apache/etc
role :app, "damedia.com"                         # This may be the same as your `Web` server
role :db,  "damedia.com"   , :primary => true # This is where Rails migrations will run
